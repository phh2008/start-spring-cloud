...
public class RsaKeyHelper {
    ...
    public PublicKey getPublicKey(byte[] publicKey) {
        try {
            ...
            System.err.println("获取RSA公钥异常：" + ex.getMessage());
            throw new RuntimeException("获取RSA公钥异常");
        }
    }
    ...
    public PrivateKey getPrivateKey(byte[] privateKey) {
        try {
            ...
            System.err.println("获取RSA密钥异常：" + ex.getMessage());
            throw new RuntimeException("获取RSA密钥异常");
        }
    }
