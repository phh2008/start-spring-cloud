...
public class StringUtils extends org.springframework.util.StringUtils {
    ...
    public static String randomUUID() {
        ...
        return new UUID(random.nextLong(), random.nextLong()).toString().replace(StringConst.DASH, StringConst.EMPTY);
    }
    ...
    public static String escapeHtml(String html) {
        return StringUtils.isBlank(html) ? StringConst.EMPTY : HtmlUtils.htmlEscape(html);
    }
    ...
    public static String lowerFirst(String str) {
        ...
        if (firstChar >= StringConst.U_A && firstChar <= StringConst.U_Z) {
            char[] arr = str.toCharArray();
            arr[0] += (StringConst.L_A - StringConst.U_A);
    ...
    public static String upperFirst(String str) {
        char firstChar = str.charAt(0);
        if (firstChar >= StringConst.L_A && firstChar <= StringConst.L_Z) {
            char[] arr = str.toCharArray();
            arr[0] -= (StringConst.L_A - StringConst.U_A);
            return new String(arr);
        }
    ...
    public static int count(CharSequence content, CharSequence strForSearch) {
        if (isEmpty(content) || isEmpty(strForSearch) || strForSearch.length() > content.length()) {
            return 0;
        }
